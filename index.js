...
app.post("/api/submitfeedback", async(req, res) => {
    ...
    try {
        ...
        const userId = decodedToken; // Assuming the token contains the user's ID

        // Create a new feedback document with the provided userId
        const feedback = new Feedback({
            userId, // Use the obtained userId
            text,
            rating,
        });
